...
$queryDataPendaftar = mysqli_query($connection, "SELECT peserta_pelatihan.*, jurusan.nama_jurusan, gelombang.nama_gelombang FROM peserta_pelatihan LEFT JOIN jurusan ON peserta_pelatihan.id_jurusan=jurusan.id LEFT JOIN gelombang ON peserta_pelatihan.id_gelombang=gelombang.id WHERE peserta_pelatihan.deleted_at=0 ORDER BY id DESC");
...
<div class="wrapper">
  <div class="card mt-3">
    <div class="card-body">
      <h3 class="card-title">Data Pendaftaran Pelatihan</h3>
        ...
        <tbody>
          ...
          while ($rowDataPendaftar = mysqli_fetch_assoc($queryDataPendaftar)) : ?>
            <tr>
              ...
              <td>
                <a href="?pg=add-data-pendaftaran-pelatihan&edit=<?php echo $rowDataPendaftar['id'] ?>">
                ...
                <a onclick="return confirm ('Apakah anda yakin akan menghapus data ini?')"
                  href="?pg=add-data-pendaftaran-pelatihan&delete=<?php echo $rowDataPendaftar['id'] ?>">
                  <button class="btn btn-light">
